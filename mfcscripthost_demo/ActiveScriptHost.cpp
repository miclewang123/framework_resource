...
//	v1.10 : Add 'InvokeFuncHelper' allows to call script function directly from c++
//  v1.5  : Add support for Host event (now derive from COleControl instead of CCmdTarget)
///////////////////////////////////////////////////////////////////////////////
#include "stdafx.h"
...
BEGIN_DISPATCH_MAP(CActiveScriptHost, COleControl)
END_DISPATCH_MAP()

BEGIN_INTERFACE_MAP(CActiveScriptHost, COleControl)
	...
	INTERFACE_PART(CActiveScriptHost, IID_IProvideMultipleClassInfo, ProvideMultipleClassInfo)
END_INTERFACE_MAP()

IMPLEMENT_DYNAMIC(CActiveScriptHost, COleControl)
IMPLEMENT_OLECTLTYPE(CActiveScriptHost, 0, 0)
...
///////////////////////////////////////////////////////////////////////////////
// XProvideMultipleClassInfo::AddRef
STDMETHODIMP_(ULONG)CActiveScriptHost::XProvideMultipleClassInfo::AddRef()
{
    METHOD_PROLOGUE(CActiveScriptHost, ProvideMultipleClassInfo)
    return pThis->ExternalAddRef();
}

///////////////////////////////////////////////////////////////////////////////
// XProvideMultipleClassInfo::Release
STDMETHODIMP_(ULONG)CActiveScriptHost::XProvideMultipleClassInfo::Release()
{
    METHOD_PROLOGUE(CActiveScriptHost, ProvideMultipleClassInfo)
...
///////////////////////////////////////////////////////////////////////////////
// XProvideMultipleClassInfo::QueryInterface
STDMETHODIMP CActiveScriptHost::XProvideMultipleClassInfo::QueryInterface(
...
///////////////////////////////////////////////////////////////////////////////
// XProvideMultipleClassInfo::GetClassInfo
STDMETHODIMP CActiveScriptHost::XProvideMultipleClassInfo::GetClassInfo(LPTYPEINFO* ppTypeInfo)
{
	METHOD_PROLOGUE_EX_(CActiveScriptHost, ProvideMultipleClassInfo)
...
///////////////////////////////////////////////////////////////////////////////
// XProvideMultipleClassInfo::GetGUID
STDMETHODIMP CActiveScriptHost::XProvideMultipleClassInfo::GetGUID(DWORD dwGuidKind, GUID* pGUID)
{
	METHOD_PROLOGUE_EX_(CActiveScriptHost, ProvideMultipleClassInfo)
...
///////////////////////////////////////////////////////////////////////////////
// XProvideMultipleClassInfo::GetMultiTypeInfoCount
STDMETHODIMP CActiveScriptHost::XProvideMultipleClassInfo::GetMultiTypeInfoCount(ULONG* pcti)
{
	METHOD_PROLOGUE_EX_(CActiveScriptHost, ProvideMultipleClassInfo)
	*pcti = 1;
	return S_OK;
...
///////////////////////////////////////////////////////////////////////////////
// XProvideMultipleClassInfo::GetInfoOfIndex
STDMETHODIMP CActiveScriptHost::XProvideMultipleClassInfo::GetInfoOfIndex(ULONG  itinfo,
   DWORD  dwMCIFlags, ITypeInfo   **pptinfo, DWORD  *pdwTIFlags,
   ULONG  *pcdispidReserved, IID  *piidPrimary, IID  *piidSource)
{
	...
	return pThis->GetTypeInfoOfGuid(LOCALE_SCRIPT_DEFAULT, iid, pptinfo);
}
...
{
    METHOD_PROLOGUE(CActiveScriptHost, ActiveScriptSiteWindow)
    return pThis->ExternalAddRef();
}
